...
namespace pcpp
{
	...
	public:
		...
		static SSHLayer* createSSHMessage(uint8_t* data, size_t dataLen, Layer* prevLayer, ILayerOwner* packet);
	...
	public:
		...
		static SSHIdentificationMessage* tryParse(uint8_t* data, size_t dataLen, Layer* prevLayer, ILayerOwner* packet);
	...
	public:
		...
		/// will be returned
		static SSHHandshakeMessage* tryParse(uint8_t* data, size_t dataLen, Layer* prevLayer, ILayerOwner* packet);
...
#pragma pack(pop)
	...
	public:
		...
		/// @param[in] prevLayer A pointer to the previous layer
		/// @param[in] packet A pointer to the Packet instance where layer will be stored in
		SSHKeyExchangeInitMessage(uint8_t* data, size_t dataLen, Layer* prevLayer, ILayerOwner* packet);
