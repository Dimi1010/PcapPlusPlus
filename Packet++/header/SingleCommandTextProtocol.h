...
namespace pcpp
{
	...
	class SingleCommandTextProtocol : public WithDynamicSizeOf<SingleCommandTextProtocol, Layer>
	{
		using BaseLayer = WithDynamicSizeOf<SingleCommandTextProtocol, Layer>;
	private:
